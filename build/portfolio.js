...
import { z } from "zod";
import { DEX_ADDRESSES, ERC1155_ABI, ERC20_ABI, ERC721_ABI, UNISWAP_V2_FACTORY_ABI, UNISWAP_V2_PAIR_ABI, WMON_ADDRESS, } from "./shared/constants.js";
...
server.tool("portfolio", "Analyser le portefeuille complet d'une adresse sur Monad Testnet", {
...
async ({ address, includeErc20, includeNfts, includeLiquidityPositions, includeTransactionHistory, transactionLimit, erc20TokensLimit, nftsLimit, }, _extra) => {
    try {
