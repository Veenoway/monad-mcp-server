...
server.tool("nft-holders", "Get the list of holders for a specific NFT on Monad Testnet", {
            ...
            try {
                ...
                if (tokenId) {
                    ...
                    try {
                        ...
                        console.error("Contract does not implement totalSupply/tokenByIndex, using event method");
                    }
                    if (isEnumerable) {
                            ...
                            if (decodedEvent && decodedEvent.args) {
                                ...
                                if (!processedTokens.has(tokenIdFromEvent)) {
                                    ...
                                    try {
                                        ...
                                        console.error(`Error retrieving owner for token ${tokenIdFromEvent}:`, error);
                                    }
                                }
                            }
                        }
